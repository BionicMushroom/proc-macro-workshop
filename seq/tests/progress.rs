...
fn tests() {
    ...
    t.pass("tests/10-different-range-values.rs");
    t.pass("tests/11-repeat-without-ident.rs");
    t.pass("tests/12-complex-idents.rs");
    t.pass("tests/13-multiple-repeat-sections.rs");
}
